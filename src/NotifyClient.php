...
namespace NotifyEu\Notify;

use Exception;
use GuzzleHttp\Client;
use GuzzleHttp\Exception\ClientException;
use NotifyEu\Notify\Exceptions\CouldNotSendNotification;
use NotifyEu\Notify\Exceptions\InvalidConfiguration;
use NotifyEu\Notify\Exceptions\InvalidMessageObject;
